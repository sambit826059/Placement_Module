  ...
  return (
        ...
        <div className="bg-gray-200  p-2 pr-4 md:p-2 sm:pr-12 md:pr-12   ">    
                    ...
                    <div className={ ` top-[3.5rem]  max-sm:fixed   max-sm:bg-green-200    min-md:relative  min-md:bg-green-00    md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-2 max-sm:pl-0 transition-all duration-500 ease-in  ${OpenNavMenu ? 'top-15 max-sm:block ':'top-[-20rem] max-sm:hidden'}   `}>
                        ...
                        {/* <span class=" invisible group-active:visible before:absolute  before:top-11 before:right-[28rem] before:w-16 before:h-1 before:bg-black"></span> */}
                            <NavLink  to="/Student/Home" className={ ({isActive}) => `  ${ isActive ? "  before:bg-black " : "  bg-transparent"} hover:bg-gray-300 before:absolute  before:top-11 before:right-[28rem] before:w-16 before:h-1    px-2 py-1 max-sm:py-3  max-sm:text-2xl rounded md:text-center `}> <li >Home </li></NavLink> 
                            ...
                            <NavLink to="/Student/apply" className={({isActive}) => `${ isActive ? "  before:bg-black " : "  bg-transparent"} hover:bg-gray-300 before:rounded-full  before:absolute  before:top-11 before:right-[16rem] before:w-16 before:h-1    px-2 py-1 max-sm:py-3  max-sm:text-2xl rounded md:text-center `}> <li >Apply </li></NavLink>
